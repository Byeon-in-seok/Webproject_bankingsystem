...
<%
	...
	long money = Long.parseLong(request.getParameter("sendmoney"));
...
if(money < 0){%>
	...
	try{
		...
		PreparedStatement gg = cc.prepareStatement("insert into transaction_ values('입금',?,?,?,?, sysdate())");
		gg.setString(1,id);
		gg.setLong(2,send);
		gg.setLong(3,membercount);
		gg.setLong(4,money);
		gg.executeUpdate();
		%><script>
		alert("입금완료. 거래 감사합니다.");
